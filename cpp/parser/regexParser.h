...
public:
  enum {
    ...
    T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11, AnyCharacter = 12, CharacterClassAnyWord = 13, 
    CharacterClassAnyWordInverted = 14, CharacterClassAnyDecimalDigit = 15, 
    CharacterClassAnyDecimalDigitInverted = 16, CharacterClassAnyBlank = 17, 
    CharacterClassAnyBlankInverted = 18, ZeroOrMoreQuantifier = 19, OneOrMoreQuantifier = 20, 
    ZeroOrOneQuantifier = 21, AnchorStartOfString = 22, AnchorWordBoundary = 23, 
    AnchorNonWordBoundary = 24, AnchorEndOfString = 25, EscapedChar = 26, 
    Digit = 27, Char = 28
  };
  ...
  enum {
    ...
    RuleInteger = 19, RuleBackreference = 20, RuleAnchor = 21, RuleChar = 22, 
    RuleCharInGroup = 23
  };
  ...
  public:
    ...
    GroupContext *group();
    BackreferenceContext *backreference();
  ...
  class  BackreferenceContext : public antlr4::ParserRuleContext {
  public:
    BackreferenceContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IntegerContext *integer();
