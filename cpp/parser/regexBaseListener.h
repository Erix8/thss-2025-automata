...
public:
  ...
  virtual void enterBackreference(regexParser::BackreferenceContext * /*ctx*/) override { }
  virtual void exitBackreference(regexParser::BackreferenceContext * /*ctx*/) override { }
